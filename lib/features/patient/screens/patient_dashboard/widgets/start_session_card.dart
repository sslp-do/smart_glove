...
import 'package:smart_glove/features/patient/screens/live_session/screen/live_session.dart';
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Duration: ${exercise.duration} mins • Reps: ${exercise.targetRepetitions} ",
