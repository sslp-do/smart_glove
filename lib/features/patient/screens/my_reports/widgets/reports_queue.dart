...
import 'package:smart_glove/features/patient/screens/my_reports/screen/session_report.dart';
    ...
    if (reports.reports.isEmpty)
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final isNew = index == 0;
          return _ReportCard(session: session, isNew: isNew);
        },
      );
  }
}
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => SessionReportScreen(reportId: "reportId"),
        ),
      ),
      child: Container(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(Icons.fitness_center, color: _teal, size: 18),
                ...
                Row(
                  children: [
                    ...
                    _InfoChip(
                      icon: Icons.timer,
                      label: "${session.duration.inMinutes} min",
                ...
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Icon(Icons.trending_up, color: _teal, size: 16),
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            SessionReportScreen(reportId: "reportId"),
                      ),
                    );
                  },
                ),
