...
import 'package:smart_glove/features/patient/models/badge_item.dart';
...
class BadgesProvider extends ChangeNotifier{
 ...
 void updateBadgeStatus(Patient patient){
    ...
    if( patient.recoveryProgress > 10 && !newList.contains("Grip Master") )
    {
  ...
  void updateBadges(Patient patient) {
    ...
    final rules = {
      "Grip Master": patient.recoveryProgress > 10,
