            ...
            children: [
                  ...
                  Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          "Report ID: ${_aiReports[_selectedIndex]['id']}",
                          style: TextStyle(
                            fontSize: 12,
                      ...
                      Text(
                        _aiReports[_selectedIndex]['patientName'],
                      ...
                      Text(
                        "Exercise: ${_aiReports[_selectedIndex]['session']} • ${_aiReports[_selectedIndex]['date']}",
                        style: const TextStyle(
                          fontSize: 14,
              ...
              Row(
                children: [
                  _buildMetricCard(
                    "Target Angle",
                    "${_aiReports[_selectedIndex]['metrics']['targetAngle']}°",
                    Icons.track_changes,
                    Colors.blue,
                  ),
                  ...
                  _buildMetricCard(
                    "Achieved Angle",
                    "${_aiReports[_selectedIndex]['metrics']['achievedAngle']}°",
                    Icons.sports_score,
                    _aiReports[_selectedIndex]['metrics']['achievedAngle'] <
                        _aiReports[_selectedIndex]['metrics']['targetAngle']
                        ? Colors.orange
                  ...
                  _buildMetricCard(
                    "Tremor Detection",
                    _aiReports[_selectedIndex]['metrics']['tremorLevel'],
                    Icons.vibration,
                    _aiReports[_selectedIndex]['metrics']['tremorLevel'] ==
                        "Low"
                        ? Colors.redAccent
                  ...
                  children: [
                    ...
                    TextField(
                      controller: TextEditingController(
                        text: _aiReports[_selectedIndex]['aiSummary'],
                      ),
                      maxLines: 4,
                      style: const TextStyle(
                        fontSize: 16,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  _aiReports[_selectedIndex]['aiRecommendation'],
                                  style: const TextStyle(
                                    color: Colors.black87,
                                    fontSize: 14,
                                  ),
