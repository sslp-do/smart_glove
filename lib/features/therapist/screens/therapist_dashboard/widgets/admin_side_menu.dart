...
class TherapistSideMenu extends StatelessWidget {
  final bool isCollapsed;
  const TherapistSideMenu({super.key, required this.isCollapsed});
     ...
     // width: 200,
      ...
      child: ListTile(
        ...
        onTap:() {
          ...
          if( title=="AI Analytics") context.read<NavigationProvider>().setCollapsed(true);
